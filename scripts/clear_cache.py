...
def create_image_lists(image_dir, testing_percentage, validation_percentage):
  ...
  for sub_dir in sub_dirs:
    ...
    tf.logging.info("ITENS IN TRAINING: " + str(len(training_images)))
    tf.logging.info("ITENS IN VALIDATION: " + str(len(validation_images)))
    tf.logging.info("ITENS IN TESTING: " + str(len(testing_images)))
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      ...
      type=str,
      default='',
      help='Path to folders of labeled images TEST.'
  )
  parser.add_argument(
      '--output_graph',
      type=str,
